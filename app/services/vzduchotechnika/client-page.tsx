...
import { Wind, Shield, CheckCircle, Droplets, Factory, Clock } from "lucide-react"
import { Button } from "@/components/ui/button"
import { ArrowRight, Phone, Mail } from "lucide-react"

export default function VzduchotechnikaClientPage() {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-balance">
                Vzduchotechnika pomocí <span className="text-primary">FuranFlex</span>
              </h1>
              <p className="text-xl lg:text-2xl text-muted-foreground mb-8 leading-relaxed">
                Vertikální vedení vzduchotechniky odolné vůči chemikáliím a korozi.
              </p>
            ...
            <div className="relative h-[400px] lg:h-[600px] rounded-sm overflow-hidden shadow-2xl">
              <Image src="/modern-ventilation-duct-system.jpg" alt="Vzduchotechnika" fill className="object-cover" priority />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-32">
        <div className="container mx-auto px-4 lg:px-8">
          <h2 className="text-3xl lg:text-5xl font-bold mb-12 text-center text-balance">
            Proč zvolit FuranFlex pro vzduchotechniku
          </h2>
            ...
            {[
              {
                icon: Wind,
                title: "Hladký povrch",
                description: "Minimální odpor vzduchu díky dokonale hladkému vnitřnímu povrchu",
              },
              {
                icon: Shield,
                title: "Odolnost",
                description: "Vysoká odolnost vůči mechanickému poškození a extrémním podmínkám",
              },
              {
                icon: Droplets,
                title: "Chemická stálost",
                description: "Odolné vůči chemikáliím a korozi i v náročném prostředí",
              },
              {
                icon: Factory,
                title: "Dlouhá životnost",
                description: "Minimální údržba a garantovaná dlouhá životnost systému",
              },
              {
                icon: CheckCircle,
                title: "Certifikováno",
                description: "Splňuje všechny normy a požadavky pro vzduchotechnická vedení",
              },
              {
                icon: Clock,
