  ...
  return (
    <section className="py-12 bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="mb-16 px-4">
        <div className="max-w-screen-2xl mx-auto flex flex-wrap items-center justify-center gap-6 md:gap-12 p-6 md:p-10 bg-white rounded-2xl border-2 border-blue-100 shadow-xl">
          {/* Google Reviews Badge */}
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-gradient-to-br from-blue-50 to-white rounded-full flex items-center justify-center shadow-md border-2 border-blue-100">
            ...
            <div className="text-left">
              <div className="flex items-center gap-1 mb-1">
                ...
                <span className="ml-2 text-4xl font-bold text-gray-900">4.9</span>
              </div>
          ...
          {/* Divider */}
          <div className="hidden lg:block w-px h-24 bg-gray-300" />

          {/* Certifications */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-10 flex-1">
            {certifications.map((cert, index) => (
              <div key={index} className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-blue-600 mb-2">{cert.name}</div>
                <div className="text-sm md:text-base text-gray-600 font-medium">{cert.description}</div>
              </div>
            ))}
          </div>
        </div>
