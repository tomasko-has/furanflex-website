        ...
        <div ref={processRef} className="grid lg:grid-cols-2 gap-12 items-center">
          <div className={`space-y-6 animate-on-scroll ${processVisible ? "animate-fade-in-left animated" : ""}`}>
            ...
            <div className="pt-6">
              ...
              <p className="text-sm text-muted-foreground mt-3">
                Kontaktujte nás ještě dnes a získejte nezávaznou cenovou nabídku zdarma
              </p>
            </div>
          </div>
          ...
          <div className={`relative animate-on-scroll ${processVisible ? "animate-fade-in-right animated" : ""}`}>
            ...
            <div className="absolute -bottom-4 -right-4 lg:-bottom-6 lg:-right-6 bg-primary text-primary-foreground p-4 lg:p-8 rounded-sm shadow-xl hover:scale-110 transition-transform">
              <div className="text-3xl lg:text-5xl font-bold font-mono">1 den</div>
              <div className="text-xs lg:text-base font-medium opacity-90 mt-1 lg:mt-2">kompletní instalace</div>
            </div>
          </div>
        </div>
      </div>
